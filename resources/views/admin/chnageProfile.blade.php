        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="dropdown-item" action="{{route('admin.changeImageTutor')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
            ...
            <ul class="list-group">
                <li class="list-group-item" style="cursor:pointer">
                    ...
                    <div id="demo" class="collapse">
                        <form action="{{route('admin.changeTutorName')}}" method="post">
                            @csrf
                            @method('PUT')
                            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div id="edit-address-form" class="md-form form-sm">
                                <div class="row">
                                    <div class="col-9">
                                        <form id="update-address" action="{{route('admin.updateAddress')}}" method="post">
                                            @csrf
                                            @method('PUT')
